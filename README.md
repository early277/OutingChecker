...
OutingChecker は、持ち物チェックを **アプリ本体** と **ウィジェット** の両方から管理できる iOS アプリです。
...
以下の 4 種類のホーム画面ウィジェットを用意しています。

1. **スモール：1列4行（スイッチ + 項目名）**
2. **スモール：2列4行（スイッチのみ）**
3. **ラージ：2列4行（スイッチ + 項目名）**
4. **ラージ：4列4行（スイッチのみ）**

加えて、ロック画面向けウィジェット（Inline / Rectangular）を提供します。
